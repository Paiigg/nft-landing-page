    ...
    <footer className='bg-[#242424] text-white'>
      <div className='max-w-[1240px] mx-auto px-4 py-16'>
        <div className='flex flex-col md:flex-row justify-between items-center gap-10'>
          <div className='flex items-start md:items-center flex-col md:flex-row gap-20'>
          ...
          <div className='flex flex-col gap-5'>
            ...
            <div className='flex items-center '>
              <input type="text" className='px-5 py-3 bg-primary focus:outline-none w-full' placeholder='Enter your email' />
              <button type='button' className='bg-green px-9 py-3'>Subscribe</button>
            </div>
          </div>
