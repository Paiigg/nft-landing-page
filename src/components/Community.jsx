      ...
      <div className="max-w-[1240px] mx-auto px-4 py-10">
        <div className="grid grid-cols-1 md:grid-cols-2 place-items-center">
          <div className="flex flex-col px-4 gap-5">
            ...
            <p>
              Meet the Aking Community, asrtist and collectors for platform
              update, announcement and more ...
            </p>
            <button
              type="button"
              className="bg-green px-6 w-full md:w-[200px] flex items-center gap-2 py-3"
            >
              <FaDiscord size={20} />
              Launch Discord
            </button>
